...
/***/ function(module, exports, __webpack_require__) {
	...
	var threeX = function threeX(cellOne, cellTwo, cellThree) {
	  return cellOne === 'x' && cellTwo === 'x' && cellThree === 'x';
	};

	var threeO = function threeO(cellOne, cellTwo, cellThree) {
	  return cellOne === 'o' && cellTwo === 'o' && cellThree === 'o';
	};

	var rowWinX = function rowWinX() {
	  return threeX(gameBoardArray[0], gameBoardArray[1], gameBoardArray[2]) || threeX(gameBoardArray[3], gameBoardArray[4], gameBoardArray[5]) || threeX(gameBoardArray[6], gameBoardArray[7], gameBoardArray[8]);
	};

	var oWinRows = function oWinRows() {
	  return threeO(gameBoardArray[0], gameBoardArray[1], gameBoardArray[2]) || threeO(gameBoardArray[3], gameBoardArray[4], gameBoardArray[5]) || threeO(gameBoardArray[6], gameBoardArray[7], gameBoardArray[8]);
	};

	var columnWinX = function columnWinX() {
	  return threeX(gameBoardArray[0], gameBoardArray[3], gameBoardArray[6]) || threeX(gameBoardArray[1], gameBoardArray[4], gameBoardArray[7]) || threeX(gameBoardArray[2], gameBoardArray[5], gameBoardArray[8]);
	};

	var oWinCol = function oWinCol() {
	  return threeO(gameBoardArray[0], gameBoardArray[3], gameBoardArray[6]) || threeO(gameBoardArray[1], gameBoardArray[4], gameBoardArray[7]) || threeO(gameBoardArray[2], gameBoardArray[5], gameBoardArray[8]);
	};

	var diagonalWinX = function diagonalWinX() {
	  return threeX(gameBoardArray[0], gameBoardArray[4], gameBoardArray[8]) || threeX(gameBoardArray[6], gameBoardArray[4], gameBoardArray[2]);
	};

	var oWinDiag = function oWinDiag() {
	  return threeO(gameBoardArray[0], gameBoardArray[4], gameBoardArray[8]) || threeO(gameBoardArray[6], gameBoardArray[4], gameBoardArray[2]);
	};
	...
	var xOonBoard = function xOonBoard(event) {
	...
	var onGetGame = function onGetGame(event) {
	  ...
	  api.getGame(data).done(ui.getSuccess).fail(ui.failure);
	};
